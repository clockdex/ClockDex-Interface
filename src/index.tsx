...
const ReactApp = () => {
  ...
  return (
    <StrictMode>
      <SEO
        title="Clock Up System - Swap and earn tokens at the best rates"
        description="Clock Up System is DeFi’s first Dynamic Market Maker; a decentralized exchange protocol that provides frictionless crypto liquidity with extremely high flexibility and capital efficiency. Clock Up System is the first major protocol in Kyber’s liquidity hub."
      />
      <FixedGlobalStyle />
