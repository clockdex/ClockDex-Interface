...
export const FooterSocialLink = () => {
  ...
  return (
    <Flex alignItems="center" justifyContent="center" sx={{ gap: '24px' }}>
      <ExternalLinkNoLineHeight href="https://t.me/ClockUpSystem">
        ...
        <InfoWrapper>
          <Item>
            <Text marginRight="6px">
              <Trans>Create By ClockDex</Trans>
            </Text>
            <ExternalLink href="https://clockupsystem.com/" style={{ display: 'flex' }}></ExternalLink>
          </Item>
          <Separator />

          <Item>
            <Text marginRight="6px" display="flex">
              <Trans>Audited Soon</Trans>
