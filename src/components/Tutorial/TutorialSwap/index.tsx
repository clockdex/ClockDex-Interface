...
function Welcome() {
  return (
    <Layout>
      <img
        src="https://builtin.com/sites/www.builtin.com/files/styles/og/public/2022-09/blockchain.png"
        alt="welcome to ClockDex"
        style={{ maxWidth: '100%', marginTop: 10 }}
      />
      <Desc>
        <Trans>
          ClockDex is a decentralized exchange (DEX) aggregator. We provide our traders with the{' '}
          <HighlightText>best token prices</HighlightText> by analyzing rates across thousands of exchanges instantly!
        </Trans>
      </Desc>
      <Desc>
        <Trans>
          ClodeDex is also an automated market maker (AMM) with industry-leading liquidity protocols and{' '}
      ...
      <Desc>
        <Trans>
          We created this <HighlightText>quick tutorial</HighlightText> guide for you to highlight Clodedex main
          features.
        </Trans>
      </Desc>
      <Desc>
...
function ConnectWallet() {
  ...
  return (
    <Layout title={LIST_TITLE.CONNECT_WALLET}>
      <Desc>
        <Trans>Choose your preferred wallet, connect it, and get started with ClockDex</Trans>
      </Desc>
    ...
    },
    {
      ...
      description: (
        <Layout title={LIST_TITLE.SELECT_NETWORK}>
          <Desc>
            <Trans>
              Choose your preferred network. ClockDex is a multi chain platform that supports over 12 networks!
            </Trans>
          </Desc>
